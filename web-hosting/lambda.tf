...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:${var.aws_region}:${var.accountId}:${aws_api_gateway_rest_api.demo.id}/*/${aws_api_gateway_method.DemoMethod.http_method}${aws_api_gateway_resource.DemoResource.path}"
}
